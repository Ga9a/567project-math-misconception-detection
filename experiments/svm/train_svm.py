...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Linear SVM baseline.")
    parser.add_argument("--feature-dir", default="features")
    parser.add_argument("--output-dir", default="experiments/svm/outputs")
...
def save_predictions(feature_dir, y_true, y_pred, labels, output_path):
...
def main():
    ...
    save_predictions(feature_dir, y_val, y_pred, labels, output_dir / "val_predictions.csv")
    ...
    if not args.no_save_model:
        joblib.dump(model, output_dir / "linear_svm_model.joblib")
